...
const Header = () => {
    ...
    return ( <
        ...
        style = {
            { height: "20px", width: "40px", marginLeft: "5px" }
        } >
        <
        /ion-icon> <
        div >
        <
        p style = {
            { marginRight: "100px", marginTop: "13px" }
        } > To Do < /p> < /
        div > <
        div className = "input" >
        <
        ...
        <
        svg style = {
            { marginLeft: "30px", height: "20px", width: "40px" }
        }
        xmlns = "http://www.w3.org/2000/svg"
        width = "16"
        height = "16"
        ...
        a > <
        p style = {
            { marginTop: "15px", marginLeft: "12px" }
        } > { " " } <
        a href = "#" > New List < /a> < /
        p > <
        /div> < /
        ...
        /div> <
        svg style = {
            { marginRight: "5px", marginTop: "20px" }
        }
        xmlns = "http://www.w3.org/2000/svg"
        width = "16"
        height = "16"
        ...
        /svg> <
        p style = {
            { marginRight: "20px", marginTop: "17px" }
        } > Sort < /p> <
        svg style = {
            { marginTop: "20px", marginRight: "5px" }
        }
        xmlns = "http://www.w3.org/2000/svg"
        width = "16"
        height = "16"
        ...
        /svg> <
        p style = {
            { marginTop: "13px", marginLeft: "12px" }
        } >
        <
        a href = "#" > Add Step < /a> < /
        p > <
